...
\noindent The zip-file is password protected, contains a single file \verb+eggge.png+.  Everything else in this challenge is also palindromic, so assume that the password is as well.
